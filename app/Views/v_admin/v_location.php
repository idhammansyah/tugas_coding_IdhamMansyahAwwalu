...
<section class="dashboard">
  <div class="row">
    <div class="col-xl-12">
      <div class="card">
        <h4 class="card-header fw-bold text-dark text-uppercase"><i class="bi bi-geo-alt-fill"></i>&nbsp; Location
        </h4>
        <div class="filter">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
            ...
            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_new_Location"><i
                  class="bi bi-plus-square"></i>&nbsp; Add New Location</a>
            </li>
          </ul>
        </div>
        <div class="card-body">
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    dataTable = $('#level_tables').DataTable({
      ...
      'searching': true,
      "ajax": {
        "url": "<?= route_to('datatables_location');?>",
        "type": "POST"
      },
      "columns": [{
          data: null,
